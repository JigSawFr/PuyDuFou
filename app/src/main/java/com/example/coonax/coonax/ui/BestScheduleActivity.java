...
public class BestScheduleActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_best_schedule);
        ...
        try {
            puyDuFouService.listOptimizedScheduleAsync("08", "30", "30", new Callback<List<Schedule>>() {
                ...
                public void failure(RetrofitError error) {
                    Log.w("PUYDUFOU", "SCHEDULES_OPTIMIZED_ACTIVITY :: Impossible de récupérer les programmes");
                    Log.w("PUYDUFOU", "SCHEDULES_OPTIMIZED_ACTIVITY :: " + error);
                    Toast.makeText(getApplicationContext(), "FAIL" + error, Toast.LENGTH_LONG).show();
                }
            });
        }
        catch (Exception e) {
            Log.w("PUYDUFOU", "SCHEDULES_OPTIMIZED_ACTIVITY :: EXCEPTION: " + e);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_best_schedule, menu);
        return true;
    }
